...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Flash_CS_Pin|Buz_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TFT_CS_Pin|DHT_Pin|SD_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : TFT_CS_Pin TFT_DC_Pin SD_CS_Pin */
  GPIO_InitStruct.Pin = TFT_CS_Pin|TFT_DC_Pin|SD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
